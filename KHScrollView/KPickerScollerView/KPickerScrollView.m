...
@interface KPickerScrollView ()<UIScrollViewDelegate>
...
@implementation KPickerScrollView
...
- (void)layoutItems
{
    ...
    for (int i = 0; i < self.items.count; i++) {
        KPickerItem *item = [self.items objectAtIndex:i];
...
{
    // remove
    for (KPickerItem *item in self.items) {
...
- (void)itemInCenterChange:(KPickerItem*)item
{
...
- (void)itemInCenterBack:(KPickerItem*)item
{
